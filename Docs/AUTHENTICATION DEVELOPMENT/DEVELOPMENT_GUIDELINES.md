...
`Session Coordination Distribuida + Assurance Profile Explicito + Alineacion Con Controllers Security`
...
2. assurance profile explicito en `AuthenticationContext` o equivalente.
