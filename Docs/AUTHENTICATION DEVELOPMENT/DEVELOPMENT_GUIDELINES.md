...
`Session Coordination Distribuida + Tooling/Cleanup De Tombstones + Policy/Authorization De Revocacion + Alineacion Con Controllers Security`
...
5. tooling operativo minimo para cleanup/retention del estado derivado.
