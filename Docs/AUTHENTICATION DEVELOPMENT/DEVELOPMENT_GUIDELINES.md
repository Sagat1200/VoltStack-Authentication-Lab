...
`Delegacion Administrativa Mas Rica En Runtime + Coordinacion Distribuida Mas Fuerte Del Security Center + Inventory Multi-Identidad Mas Expresivo`
...
3. inventory multi-identidad mas expresivo sobre inventories agregados dentro del runtime principal.
