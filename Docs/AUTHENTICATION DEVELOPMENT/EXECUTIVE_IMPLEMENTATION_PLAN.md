...
- ventanas temporales distribuidas sobre runtime principal y tooling operativo
...
2. enriquecer ventanas temporales distribuidas de mutaciones gobernadas reutilizando la correlacion operativa, metrica, longitudinal y store cohorts ya disponible.
