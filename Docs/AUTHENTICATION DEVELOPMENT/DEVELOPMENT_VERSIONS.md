...
1. Remember-me.
2. Bearer/API tokens.
3. mutaciones distribuidas mas fuertes sobre sessions y trusted devices, policy/authorization multi-actor y background cleanup mas completo.
4. Passkeys / WebAuthn.
5. OIDC / federacion.
6. Risk engine.
7. Policy engine.
